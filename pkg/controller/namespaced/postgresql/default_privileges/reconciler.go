...
func (c *connector) Connect(ctx context.Context, mg *v1alpha1.DefaultPrivileges) (managed.TypedExternalClient[*v1alpha1.DefaultPrivileges], error) {
	...
	s := &corev1.Secret{}
	if err := c.kube.Get(ctx, types.NamespacedName{Namespace: mg.Namespace, Name: ref.Name}, s); err != nil {
	...
	return &external{db: c.newDB(s.Data, providerInfo.DefaultDatabase, clients.ToString(pc.Spec.SSLMode))}, nil
}
