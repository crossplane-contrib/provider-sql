...
import (
	...
	"github.com/crossplane-contrib/provider-sql/pkg/controller/namespaced/mssql/grant"
	"github.com/crossplane-contrib/provider-sql/pkg/controller/namespaced/mssql/user"
)
