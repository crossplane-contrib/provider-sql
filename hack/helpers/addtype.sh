...
mkdir -p "pkg/controller/${group_lower}/${kind_lower}"
${GOMPLATE} < "hack/helpers/controller/KIND_LOWER/KIND_LOWER.go.tmpl" > "pkg/controller/${group_lower}/${kind_lower}/${kind_lower}_controller.go"
${GOMPLATE} < "hack/helpers/controller/KIND_LOWER/KIND_LOWER_test.go.tmpl" > "pkg/controller/${group_lower}/${kind_lower}/${kind_lower}_controller_test.go"
