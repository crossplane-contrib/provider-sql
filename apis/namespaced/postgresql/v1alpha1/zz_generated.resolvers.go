...
func (mg *Schema) ResolveReferences( // ResolveReferences of this Schema.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("postgresql.sql.m.crossplane.io", "v1alpha1", "Role", "RoleList")
		if err != nil {
	...
	{
		m, l, err = apisresolver.GetManagedResource("postgresql.sql.m.crossplane.io", "v1alpha1", "Database", "DatabaseList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
