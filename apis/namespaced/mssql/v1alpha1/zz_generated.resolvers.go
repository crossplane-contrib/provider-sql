...
func (mg *Grant) ResolveReferences( // ResolveReferences of this Grant.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("mssql.sql.m.crossplane.io", "v1alpha1", "User", "UserList")
		if err != nil {
	...
	{
		m, l, err = apisresolver.GetManagedResource("mssql.sql.m.crossplane.io", "v1alpha1", "Database", "DatabaseList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
