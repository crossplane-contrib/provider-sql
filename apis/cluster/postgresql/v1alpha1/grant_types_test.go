...
// pkg/controller/cluster/postgresql/grant/reconciler.go. Keep this in sync
// with the marker by hand; there is no way to read kubebuilder markers back
// out of the compiled type at runtime.
